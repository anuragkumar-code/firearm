                    ...
                    <form action="functions/product/edit-product.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-12">
                                <label class="form-label"><b>Existing Images</b></label>
                                <div class="row">
                                    <?php foreach ($existingImages as $image): ?>
                                        <div class="col-md-3">
                                            <img src="../admin/product_images/<?php echo $image['image']; ?>" class="img-thumbnail" width="150">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="deleteImages[]" value="<?php echo $image['id']; ?>">
